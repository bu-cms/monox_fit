...
def cmodel(cid,nam,_f,_fOut, out_ws, diag,year, convention="BU"):
  ...
  add_variation(WScales, f_pref, "%sUp"%variation, "qcd_wmn_weights_%s_%s_Up"%(cid, variation), _fOut)
  add_variation(WScales, f_pref, "%sDown"%variation, "qcd_wmn_weights_%s_%s_Down"%(cid, variation), _fOut)
  CRs[0].add_nuisance_shape(variation,_fOut)

  add_variation(WScales_e, f_pref, "%sUp"%variation, "qcd_wen_weights_%s_%s_Up"%(cid, variation), _fOut)
